...
//echo $pageText['title'];
?><br><br><a name=popular-artists></a><h1 class=main-page-h1><?= Yii::t('app', 'Popular artists') ?></h1><?php //echo print_r($item);?><br><br><div class="pop-artist rflex"><?php foreach ($artistsByPopularity as $artist): ?><a class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-xxs-12"href="/<?= Yii::$app->params['language']['current']['url'] ?>/artists/<?= $artist['url']; ?>/"><div><div><?php if ($artist['photos'] == 'asdsds'): ?><p><img alt="<?= $artist['name'] ?>"src="/files/artists/<?= $artist['first_letter'] ?>/<?= $artist['photos'] ?>"></p><?php endif; ?><br><br><br><br><p><?= $artist['name']; ?></p><br><br><br><br></div></div></a><?php endforeach; ?></div><br><br><br><br>